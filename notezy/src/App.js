  ...
  render() {
    return (
      <div className="App container">
        ...
        <div className="row">
          <Sidebar add={this.addNote} select={this.updateNote} selected={this.state.selectedNote} notes={this.state.notes} />
            {this.state.notes.length > 0 ? <Editor change={this.updateNote}    currentNote={this.state.selectedNote} newNote={this.state.addNote} /> : <div>Go ahead and add a note</div>}  
        </div>
      </div>
    );
  }
